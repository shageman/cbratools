...
require "super_event_counter/version"

# Describe your gem and declare its dependencies:
Gem::Specification.new do |s|
  s.name        = "super_event_counter"
  s.version     = SuperEventCounter::VERSION
  s.authors     = ["Stephan Hagemann"]
  s.email       = ["stephan@pivotallabs.com"]
  s.homepage    = "https://github.com/shageman/super_event_counter"
